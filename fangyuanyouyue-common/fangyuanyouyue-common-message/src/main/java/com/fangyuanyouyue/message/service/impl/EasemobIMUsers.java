...
import com.fangyuanyouyue.message.service.IMUserAPI;
...
@Service(value = "easemobIMUsers")
public class EasemobIMUsers  implements IMUserAPI {
	
	public static void main(String[] args) {

        RegisterUsers users = new RegisterUsers();
        User user = new User().username("aaaa12sfs3456" + new Random().nextInt(500)).password("123456");
        users.add(user);
		Object object = new EasemobIMUsers().createNewIMUserSingle(users);
