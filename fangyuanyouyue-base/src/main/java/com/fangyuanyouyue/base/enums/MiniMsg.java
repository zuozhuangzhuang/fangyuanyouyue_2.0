 ...
 */
public enum MiniMsg {
    SYSTEM_MSG(1,"审核结果通知","9PCKkgtnPg0vL_uyz7L0Fr8OvXDJz-amOjG5PCCZg-A","page/tabBar/index/index"),
    ...
    REFUND_SUCCESS(8,"退款成功通知","0ewa6a6F3A9IQVt4wJwFNv1FEMSk__wRolJJqzUDsGw","page/tabBar/index/index"),
    REFUND_FAILED(9,"退款失败通知","IGQUFPamaa3grODQCT6uvTxlq7eWzP_Cq2BeLpfeDNk","page/tabBar/index/index"),
    ;
