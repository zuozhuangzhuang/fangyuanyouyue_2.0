...
import com.fangyuanyouyue.base.util.alipay.sign.MD5;
import com.fangyuanyouyue.base.util.alipay.util.httpClient.HttpProtocolHandler;
import com.fangyuanyouyue.base.util.alipay.util.httpClient.HttpRequest;
import com.fangyuanyouyue.base.util.alipay.util.httpClient.HttpResponse;
import com.fangyuanyouyue.base.util.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = "";
        if("MD5".equals(AlipayConfig.sign_type_refund)) {
