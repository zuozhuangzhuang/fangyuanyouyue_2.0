...
import com.fangyuanyouyue.base.util.wechat.pay.utils.Sha1Util;
import com.fangyuanyouyue.base.util.wechat.pay.utils.TenpayUtil;
...
public class Demo {
	...
	private static String appid = "wx306dfd8f2342f051";
	private static String appsecret = "52baeacdb9a1d280d2e7e636d774c386";
	private static String partner = "1418798002";
	//这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "ShenZhenShiXiaoFangYuan123456789";
	//openId 是微信用户针对公众号的标识，授权的部分这里不解释
	private static String openId = "sfsdfsfsdf";
	//微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	private static String notifyurl = "http://test.chuangshiyiming.com/Yese";																	 // Key
	...
	//	packageParams.put("openid", openId);
		...
		System.out.println("V3 jsApi package:"+finalsign);
		return finalsign;
	}
